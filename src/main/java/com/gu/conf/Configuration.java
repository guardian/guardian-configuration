...
public interface Configuration {
    ...
    */
   String getStringProperty(String propertyName) throws PropertyNotSetException;
    ...
    */
   int getIntegerProperty(String propertyName) throws PropertyNotSetException, NumberFormatException;
    ...
    * @throws PropertyNotSetException if property has not been set
    */
   List<String> getStringPropertiesSplitByComma(String propertyName) throws PropertyNotSetException;
